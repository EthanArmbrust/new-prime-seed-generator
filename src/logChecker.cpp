...
void LogChecker::CheckFinishEasyNew(vector<string>newItems, bool verbose){
   ...
   while(checkObtainedItems(verbose, logline, false)){
      ...
      if(hasMorph && hasMissiles){
         if(items[30] == "Morph Ball Bomb" || (items[29] == "Morph Ball Bomb" && (hasPB || items[30].substr(0, 5) == "Power"))){
            if(!isAdded[30]){
               obItems[k]  = items[30];
               isAdded[30] = true;
               k++;
   ...
   countArtifacts();
   //FINAL CHECK FOR COMPLETABLITIY
   if(a == 12 && hasWave && hasIce && hasPlasma && hasMissiles && hasSJ && hasPhazon){
...
void LogChecker::CheckFinishHypermodeNew(vector<string>newItems, bool verbose, bool noFloatyAllowed, bool noSpaceJump){
   ...
   while(checkObtainedItems(verbose, logline, noSpaceJump)){
      ...
      if(hasMissiles && hasMorph && hasBombs && (hasSpider || items[6] == "Spide" || items[6] == "Spider Ball") || hasFloaty){
         if(!isAdded[6]){
            obItems[k] = items[6];
            isAdded[6] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && (hasBombs || (hasPB && (items[29] == "Bombs" || items[30] == "Bombs" || items[29] == "Morph Ball Bomb" || items[30] == "Morph Ball Bomb")))){
         if(!isAdded[29]){
            obItems[k]  = items[29];
            isAdded[29] = true;
            k++;
      ...
      if((hasMissiles && hasMorph && hasBombs && hasSJ) || (hasMissiles && hasMorph && hasBombs && hasIce)){
         if(!isAdded[33]){
            obItems[k]  = items[33];
            isAdded[33] = true;
            k++;
      ...
      if((hasMissiles && hasMorph && hasBombs && hasIce && hasPlasma) || (hasMorph && hasBombs && hasMissiles && hasBoost && (hasSJ || hasFloaty))){
         if(!isAdded[35]){
            obItems[k]  = items[35];
            isAdded[35] = true;
            k++;
      ...
      if(((hasMissiles && hasMorph && hasBombs && hasSuit) || (hasMissiles && hasMorph && hasBombs && ((e >= 4 && (hasSJ || hasCharge) || e >= 5))) || (hasMissiles && hasMorph && hasWave && (hasSJ || hasSpider))) && ((hasBoost && hasBombs) || hasPlasma)){
         if(!isAdded[37]){
            obItems[k]  = items[37];
            isAdded[37] = true;
            k++;
      ...
      if(((hasMissiles && hasMorph && hasBombs && hasSuit) || (hasMissiles && hasMorph && hasBombs && ((e >= 4 && (hasSJ || hasCharge) || e >= 5))) || (hasMissiles && hasMorph && hasWave && (hasSJ || hasSpider))) && (hasSuper && hasCharge && hasSpider)){
         if(!isAdded[38]){
            obItems[k]  = items[38];
            isAdded[38] = true;
            k++;
      ...
      if(((hasMissiles && hasMorph && hasBombs && hasSuit) || (hasMissiles && hasMorph && hasBombs && ((e >= 4 && (hasSJ || hasCharge) || e >= 5))) || (hasMissiles && hasMorph && hasWave && (hasSJ || hasSpider && hasBombs))) && ((hasBoost && hasBombs) || hasPlasma)){
         if(!isAdded[39]){
            obItems[k]  = items[39];
            isAdded[39] = true;
            k++;
      ...
      if(((hasMissiles && hasMorph && hasBombs && hasSuit) || (hasMissiles && hasMorph && hasBombs && ((e >= 4 && (hasSJ || hasCharge) || e >= 5))) || (hasMissiles && hasMorph && hasWave && (hasSJ || (hasSpider && hasBombs)))) && (hasPlasma)){
         if(!isAdded[40]){
            obItems[k]  = items[40];
            isAdded[40] = true;
            k++;
      ...
      if(((hasMissiles && hasMorph && hasBombs && hasSuit) || (hasMissiles && hasMorph && hasBombs && ((e >= 4 && (hasSJ || hasCharge) || e >= 5))) || (hasMissiles && hasMorph && hasBombs && hasWave && (hasSJ || hasSpider))) && (hasBombs || hasSpider)){
         if(!isAdded[42]){
            obItems[k]  = items[42];
            isAdded[42] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasWave && hasIce && (hasBombs || hasSpider || hasSJ) && (hasSJ || items[53].substr(0, 5) == "Space" || hasGravity || items[53].substr(0, 5) == "Gravi") && deepPhenEscape){
         if(!isAdded[53]){
            obItems[k]  = items[53];
            isAdded[53] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasBombs && hasIce && hasWave && hasPlasma && hasPB && (hasPhazon || (e >= 5 && hasBoost && hasGravity) || (e >= 9)) && deepMinesEscape){
         if(!isAdded[90]){
            obItems[k]  = items[90];
            isAdded[90] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasBombs && hasIce && hasWave && hasPlasma && hasPB && deepMinesEscape){
         if(!isAdded[89]){
            obItems[k]  = items[89];
            isAdded[89] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasBombs && hasIce && hasWave && hasPB && deepMinesEscape){
         if(!isAdded[88]){
            obItems[k]  = items[88];
            isAdded[88] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasBombs && hasIce && hasWave && deepMinesEscape && hasPlasma && hasPB && (hasXray || (hasBoost && hasSJ))){
         if(!isAdded[85]){
            obItems[k]  = items[85];
            isAdded[85] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasBombs && hasIce && (hasPB || hasBoost)){
         if(!isAdded[74]){
            obItems[k]  = items[74];
            isAdded[74] = true;
            k++;
      ...
      if(hasMissiles && hasMorph && hasWave && hasIce && (hasBombs || hasSpider || hasSJ) && (hasSJ || items[56].substr(0, 5) == "Space" || hasGravity || items[56].substr(0, 5) == "Gravi") && deepPhenEscape){
         if(!isAdded[56]){
            obItems[k]  = items[56];
            isAdded[56] = true;
            k++;
...
void LogChecker::countArtifacts(){
   ...
   while(d < 200){
      //need to add a substring thingy when I add the full name
      if(obItems[d] == "Artif" || obItems[d].substr(0, 8) == "Artifact"){
         a++;
      }
      d++;
   }
